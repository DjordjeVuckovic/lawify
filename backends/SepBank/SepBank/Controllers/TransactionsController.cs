...
namespace SepBank.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public async Task<IActionResult> MakeTransaction([Bind("ReceiverId, SenderAccountNumber, SenderExpirationMonth, SenderExpirationYear, SenderSecurityNumber, Amount, RequestStart")] MakeTransactionDTO dto)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    return RedirectToAction("TransactionSuccess"); // Redirect to a success page
                }
                else
                {
