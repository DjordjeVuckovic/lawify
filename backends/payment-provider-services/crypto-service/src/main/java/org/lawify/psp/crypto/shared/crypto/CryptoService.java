package org.lawify.psp.crypto.shared.crypto;

import lombok.extern.slf4j.Slf4j;

import org.lawify.psp.crypto.shared.crypto.utils.HexKeyUtils;
import org.lawify.psp.crypto.shared.crypto.utils.KeyGeneratorUtils;
import org.lawify.psp.crypto.shared.crypto.utils.SymmetricUtils;
...
public class CryptoService {
    public static byte[] encryptProperty(String attribute,String encryptionKey,int ivLength) {
        try {
            if (attribute == null) {
                return null;
            }
    ...
    public static String decryptProperty(byte[] dbData,String encryptionKey,int ivLength) {
        try {
            if (dbData == null) {
                return null;
            }
